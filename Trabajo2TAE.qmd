...
Como primer paso, se realiza un filtrado de los datos ya procesados anteriormente utilizando la función "var_filter". Esta función permite. filtrar la información de acuerdo a condiciones específicas, como el valor de la información, la tasa de faltantes, la tasa de valores idénticos, entre otras condiciones.
